...
<div class="content-wrapper">
    <div class="container-fluid" style="padding: 30px">
        <form id='submit-form' action="{{ url('update-location') }}" method="post" enctype="multipart/form-data">
            @csrf
            {{-- @method('PUT') --}}
            <input type="hidden" name="T_ID" value="{{ $rec_location->t_id }}">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div align="right">
                        <a class="btn btn-danger btn-sm" href="{{ url('manage-location') }}" role="button"
                            title=""><i class="icofont icofont-ui-add"></i> ย้อนกลับ</a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card" style="padding: 30px">
                        ...
                        <div class="form-group row">
                            ...
                            <div id="LOCATION_DETAIL_BSF_AREA" class="col-md-8 wf-left">
                                <textarea class="form-control" name="LOCATION_DETAIL" id="LOCATION_DETAIL">{{ $rec_location->detail }}</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
                            ...
                            <div id="LOCATION_PIC_BSF_AREA" class="col-md-8 wf-left">
                                <input type="file" name="LOCATION_PIC" id="LOCATION_PIC" class="form-control"
                                    value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div id="" class="col-md-4 wf-left">
                                <img id="" src="{{ url('uploads/' . $rec_location->main_pic) }}" alt=""
                                    style="max-width: 100%; height: auto; margin-top: 10px;" class="img-fluid rounded">
                                <span id=""
                                    style="display: block; margin-top: 5px;text-align:center;">(ภาพเดิม)</span>
                            </div>
                            <div id="imageNew" hidden class="col-md-4 wf-left">
                                <img id="preview-image" src="" alt=""
                                    style="max-width: 100%; height: auto; margin-top: 10px;" class="img-fluid rounded">
                                <span id=""
                                    style="display: block; margin-top: 5px;text-align:center;">(ภาพที่อัปโหลดใหม่)</span>
                                <a class="btn btn-danger btn-sm" style="float: right;width:31px;height:31px;"
                                    id="cancelButton" title="ยกเลิกและใข้ภาพเดิม"><b>x</b></a>
                            </div>
                        </div>
