                ...
                <div class="card" style="padding: 30px">
                    ...
                    <div class="form-group row">
                        ...
                        <div id="LOCATION_NAME_BSF_AREA" class="col-md-8 wf-left">
                            <input type="text" name="LOCATION_NAME" id="LOCATION_NAME" class="form-control" value="{{ $rec_location->title }}">
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div id="" class="col-md-4 wf-left">
                            <img id="" src="{{ url("uploads/".$rec_location->main_pic) }}" alt="" style="max-width: 100%; height: auto; margin-top: 10px;" class="img-fluid rounded">
                            <span id="" style="display: block; margin-top: 5px;text-align:center;">(ภาพเดิม)</span>
                        </div>
                        <div id="imageNew" hidden class="col-md-4 wf-left">
                            ...
                            <span id=""  style="display: block; margin-top: 5px;text-align:center;">(ภาพที่อัปโหลดใหม่)</span>
                            <a class="btn btn-danger btn-sm" style="float: right;width:31px;height:31px;" id="cancelButton" title="ยกเลิกและใข้ภาพเดิม"><b>x</b></a>
                        </div>
                    </div>
