    ...
    <div class="container-fluid" style="padding: 30px">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div align="right">
                    <a class="btn btn-success btn-sm" href="{{ url('add-location') }}" role="button" title=""><svg
                        ...
                        <tbody>
                            ...
                            @foreach ($rec_location as $index => $item)
                                <tr>
                                    ...
                                    <td style="text-align:left;"><img src="{{ url('uploads/' . $item->main_pic) }}"
                                            class="img-fluid rounded" alt="..." width="150px"></td>
                                    <td style="text-align:left;">{{ $item->create_date }}</td>
                                    <td style="text-align:left;">
                                        <a class="btn btn-warning btn-sm"
                                            href="{{ url('edit-location', ['id' => $item->t_id]) }}" role="button"
                                            title=""><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        ...
                                        <a class="btn btn-danger btn-sm"
                                            href="{{ url('delete-location', ['id' => $item->t_id]) }}" role="button"
                                            title=""
                                            onclick="return confirm('คุณต้องการลบรายการนี้หรือไม่?')"><svg
